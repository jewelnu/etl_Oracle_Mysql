...
class DegreeData(models.Model):
    ...
    roll_no = models.CharField(max_length=21, blank=True, null=True)
...
class Degsif17Y3021218(models.Model):
    uid = models.CharField(max_length=36, blank=True, null=True)
    mid = models.CharField(max_length=96, blank=True, null=True)
    reg_no = models.CharField(max_length=33, blank=True, null=True)
    roll_no = models.CharField(max_length=21, blank=True, null=True)
...
class HonP42019(models.Model):
    exm_id = models.CharField(db_column='EXM_ID', max_length=4, blank=True, null=True)  # Field name made lowercase.
    exm_year = models.CharField(db_column='EXM_YEAR', max_length=4, blank=True, null=True)  # Field name made lowercase.
    spec_st = models.CharField(db_column='SPEC_ST', max_length=10, blank=True, null=True)  # Field name made lowercase.
    exm_roll = models.CharField(db_column='EXM_ROLL', max_length=7, blank=True, null=True)  # Field name made lowercase.
    reg_no = models.CharField(db_column='REG_NO', max_length=254, blank=True, null=True)  # Field name made lowercase.
    sub_code = models.CharField(db_column='SUB_CODE', max_length=254, blank=True, null=True)  # Field name made lowercase.
    col_code = models.CharField(db_column='COL_CODE', max_length=254, blank=True, null=True)  # Field name made lowercase.
    c_code = models.CharField(db_column='C_CODE', max_length=3, blank=True, null=True)  # Field name made lowercase.
    course = models.CharField(db_column='COURSE', max_length=1, blank=True, null=True)  # Field name made lowercase.
    std_name = models.CharField(db_column='STD_NAME', max_length=142, blank=True, null=True)  # Field name made lowercase.
    fname = models.CharField(db_column='FNAME', max_length=145, blank=True, null=True)  # Field name made lowercase.
    mname = models.CharField(db_column='MNAME', max_length=142, blank=True, null=True)  # Field name made lowercase.
    std_type = models.CharField(db_column='STD_TYPE', max_length=1, blank=True, null=True)  # Field name made lowercase.
    sex = models.CharField(db_column='SEX', max_length=12, blank=True, null=True)  # Field name made lowercase.
    sess1 = models.CharField(db_column='SESS1', max_length=12, blank=True, null=True)  # Field name made lowercase.
    sess2 = models.CharField(db_column='SESS2', max_length=12, blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'hon_p4_2019'
...
class RegallDeg17Y3(models.Model):
    reg_no = models.CharField(max_length=225, blank=True, null=True)
    security = models.CharField(max_length=45, blank=True, null=True)
    coll_code = models.CharField(max_length=45, blank=True, null=True)
    type = models.CharField(max_length=9, blank=True, null=True)
    std_type = models.CharField(max_length=9, blank=True, null=True)
    sub_id = models.CharField(max_length=180, blank=True, null=True)
    sub_name = models.TextField(blank=True, null=True)
    admission_field = models.CharField(db_column='admission_', max_length=180, blank=True, null=True)  # Field renamed because it ended with '_'.
    applicant_field = models.TextField(db_column='applicant_', blank=True, null=True)  # Field renamed because it ended with '_'.
    father_nam = models.TextField(blank=True, null=True)
    mother_nam = models.TextField(blank=True, null=True)
    sess = models.CharField(max_length=180, blank=True, null=True)
    gender = models.CharField(max_length=90, blank=True, null=True)
    birth_date = models.DateField(blank=True, null=True)
    exp_sess = models.CharField(max_length=135, blank=True, null=True)
    pap_code = models.TextField(blank=True, null=True)
    status = models.CharField(max_length=180, blank=True, null=True)
    corr = models.CharField(max_length=45, blank=True, null=True)
    sub_date = models.CharField(max_length=90, blank=True, null=True)
    entry_date = models.CharField(db_column='ENTRY_DATE', max_length=144, blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'regall_deg17y3'
